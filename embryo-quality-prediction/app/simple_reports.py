...
# Import database utilities only
from src.db_utils import get_predictions_by_patient, get_unique_patients, DatabaseConnection
...
def view_prediction(prediction_id):
    ...
    try:
        ...
        # No XAI visualization in simplified version
        xai_data = None
...
if __name__ == '__main__':
    print("Starting Embryo Prediction Reports Server...")
    print(f"Reports will be available at: http://localhost:5002")
